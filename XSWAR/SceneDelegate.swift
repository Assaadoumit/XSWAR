...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func setRoot()
    {
        ...
        {
            let notificationVC = appDelegate.storyboard.instantiateViewController(withIdentifier: "NotificationVC") as! NotificationVC
        ...
        else if appDelegate.userSignUpData != nil
        {
            ...
            let homeMainPageVC = appDelegate.storyboard.instantiateViewController(withIdentifier: "HomeMainPageVC") as! HomeMainPageVC
