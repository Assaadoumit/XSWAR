...
open class SwiftLoader: UIView {
    ...
    open class func show(title: String?, animated : Bool) {
        ...
        NotificationCenter.default.addObserver(loader, selector: #selector(loader.rotated(_:)), name: UIDevice.orientationDidChangeNotification, object: nil)
    ...
    public struct Config {
         ...
         */
        public var spinnerColor = THEME_COLOR
         ...
         *  Color of title text
         */
        public var titleTextColor = THEME_COLOR
